...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_ONBiLSTM_RankMAP_tripletloss_01_41':
        margin = 0.1
        at_margin = 0.1
...
def Dynamic_get_trainSet(istest):
    ...
    pairs_train = ProcessData_Siamese_SentPair.\
        CreateTriplet_RankClassify41(tagDict_train, tagDict_dev, tagDict_test, type_W, istest=istest)
...
if __name__ == "__main__":
    ...
    modelname = 'Model_ONBiLSTM_RankMAP_tripletloss_01_41'
