...
from NNstruc.NN_Siamese import Model_ONBiLSTM_directMAPbyLSTM_tripletloss_1
import keras
...
def Dynamic_get_trainSet(istest):
    ...
    pairs_train, labels_train = ProcessData_Siamese_SentPair.CreateTriplet_DirectMAP(tagDict, target_vob=None, istest=istest)
