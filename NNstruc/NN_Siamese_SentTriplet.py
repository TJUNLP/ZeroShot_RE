...
def Model_BiLSTM_SentPair_tripletloss_Hloss_05_at01_allexp_notallat(wordvocabsize, posivocabsize, charvocabsize, tagvocabsize,
                     word_W, posi_W, char_W, tag_W,
                     input_sent_lenth, input_maxword_length,
                     w2v_k, posi2v_k, c2v_k, tag2v_k,
                    batch_size=32):
...
def Model_BiLSTM_SentPair_Atloss_ed_05_pinjie(wordvocabsize, posivocabsize, charvocabsize, tagvocabsize,
    ...
    class_pinjie = concatenate([tag_embedding, word_embedding_sent_x1], axis=1)
