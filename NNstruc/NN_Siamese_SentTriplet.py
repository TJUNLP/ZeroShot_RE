...
def Model_BiLSTM_SentPair_tripletloss_at_noclass_1(wordvocabsize, posivocabsize, charvocabsize, tagvocabsize,
                     word_W, posi_W, char_W, tag_W,
                     input_sent_lenth, input_maxword_length,
                     w2v_k, posi2v_k, c2v_k, tag2v_k,
                    batch_size=32):
    ...
    mymodel = Model([word_input_sent_x1, input_e1_posi_x1, input_e2_posi_x1, char_input_sent_x1,
                     word_input_sent_x2, input_e1_posi_x2, input_e2_posi_x2, char_input_sent_x2,
                     word_input_sent_x3, input_e1_posi_x3, input_e2_posi_x3, char_input_sent_x3], [loss, softmax_class])

    mymodel.compile(loss={'Softmax': 'categorical_crossentropy', 'Triplet': lambda y_true, y_pred: y_pred},
                    loss_weights={'Triplet': 1., 'Softmax': 0.1},
                    optimizer=optimizers.Adam(lr=0.001),
                    metrics={'Triplet':[], 'Softmax':['acc']})
