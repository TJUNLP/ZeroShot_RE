...
from NNstruc.NN_Siamese import Model_ONBiLSTM_RankMAP_tripletloss_1_nochar
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_ONBiLSTM_RankMAP_tripletloss_005_1':
        margin = 0.05
        at_margin = 0.1
        nn_model = Model_ONBiLSTM_RankMAP_tripletloss_1_nochar(wordvocabsize=wordvocabsize,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_ONBiLSTM_RankMAP_tripletloss_005_1'
