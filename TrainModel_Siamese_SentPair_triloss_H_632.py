...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_BiLSTM_SentPair_tripletloss_Hloss_03_at015_allexp_2m':
        margin = 0.3
        at_margin = 0.15
        nn_model = Model_BiLSTM_SentPair_tripletloss_Hloss_05_at01_allexp_2m(wordvocabsize=wordvocabsize,
                                                  posivocabsize=posivocabsize,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_SentPair_tripletloss_Hloss_005_at01_allexp_2m'
    modelname = 'Model_BiLSTM_SentPair_tripletloss_Hloss_03_at015_allexp_2m'
