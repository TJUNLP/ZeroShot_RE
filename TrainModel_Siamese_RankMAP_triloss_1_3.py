...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_ONBiLSTM_RankMAP_tripletloss_01_3':
        margin = 0.1
        at_margin = 0.1
        print(margin, 'Model_ONBiLSTM_directMAP_tripletloss_1')
...
def Dynamic_get_trainSet(istest):
    ...
    pairs_train = ProcessData_Siamese_SentPair.CreateTriplet_RankClassify3(tagDict, relRankDict=relRankDict, istest=istest)
...
if __name__ == "__main__":
    ...
    modelname = 'Model_ONBiLSTM_RankMAP_tripletloss_01_3'
