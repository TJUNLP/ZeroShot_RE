...
from NNstruc.NN_Siamese import Model_ONBiLSTM_directMAPbyLSTM_tripletloss_className
import keras
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_ONBiLSTM_directMAP_tripletloss_Hloss_05_01_className':
        margin = 0.5
        at_margin = 0.1
    ...
    elif modelname is 'Model_ONBiLSTM_directMAPbyLSTM_tripletloss_className':
        margin = 0.5
        at_margin = 0.1
        nn_model = Model_ONBiLSTM_directMAP_tripletloss_Hloss_className(wordvocabsize=wordvocabsize,
                                                  posivocabsize=posivocabsize,
...
if __name__ == "__main__":
    ...
    datafname = 'WikiReading_data_Siamese.WordChar.className.devsplit'
    ...
    for inum in range(0, 3):
        ...
        modelfile = "./model/" + modelname + "__" + datafname + "__" + str(inum) + "__target_vob=None.h5"
