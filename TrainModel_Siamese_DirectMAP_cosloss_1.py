...
from NNstruc.NN_Siamese import Model_ONBiLSTM_DirectMAP_cosloss_1
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_ONBiLSTM_DirectMAP_cosloss_1':
        margin1 = 0.1
        margin2 = 0.1
        margin3 = 0.1

        nn_model = Model_ONBiLSTM_DirectMAP_cosloss_1(wordvocabsize=wordvocabsize,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_ONBiLSTM_DirectMAP_cosloss_1'
