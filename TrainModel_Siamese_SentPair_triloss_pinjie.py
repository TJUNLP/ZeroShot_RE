...
from NNstruc.NN_Siamese_SentTriplet import Model_BiLSTM_SentPair_pinjie
import keras
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_BiLSTM_SentPair_tripletloss_ed_1_01':
        nn_model = Model_BiLSTM_SentPair_tripletloss_ed_1_01(wordvocabsize=wordvocabsize,
                                                  ...
                                                  batch_size=batch_size)
    elif modelname is 'Model_BiLSTM_SentPair_Atloss_ed_05':
        nn_model = Model_BiLSTM_SentPair_Atloss_ed_05(wordvocabsize=wordvocabsize,
                                                  posivocabsize=posivocabsize,
                                                  charvocabsize=charvocabsize,
                                                    tagvocabsize=tagvocabsize,
                                                  word_W=word_W, posi_W=posi_W, char_W=char_W, tag_W=tag_W,
    ...
    elif modelname is 'Model_BiLSTM_SentPair_pinjie':
        nn_model = Model_BiLSTM_SentPair_pinjie(wordvocabsize=wordvocabsize,
                                                  posivocabsize=posivocabsize,
                                                  charvocabsize=charvocabsize,
                                                    tagvocabsize=tagvocabsize,
                                                  word_W=word_W, posi_W=posi_W, char_W=char_W, tag_W=tag_W,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_SentPair_pinjie'
