...
from NNstruc.NN_Classifier import Model_BiLSTM_RankMAP_Random_tripletloss_1
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_BiLSTM_RankMAP_Random_tripletloss_1':
        nn_model = Model_BiLSTM_RankMAP_Random_tripletloss_1(wordvocabsize=wordvocabsize,
...
def Dynamic_get_trainSet(shuffle=True):
    ...
    pairs_train = ProcessData_Siamese_onlySeen.Create4Classifier_Random(tagDict_train, shuffle,
                                                                       class_num=120)
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_RankMAP_Random_tripletloss_1'
