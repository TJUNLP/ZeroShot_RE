...
from NNstruc.NN_Siamese_SentTriplet import Model_BiLSTM_SentPair_tripletloss_Hloss_05_at_exp
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    elif modelname is 'Model_BiLSTM_SentPair_tripletloss_Hloss_05_at_exp':
        nn_model = Model_BiLSTM_SentPair_tripletloss_Hloss_05_at_exp(wordvocabsize=wordvocabsize,
                                                                  posivocabsize=posivocabsize,
                                                                  charvocabsize=charvocabsize,
                                                                  tagvocabsize=tagvocabsize,
                                                                  word_W=word_W, posi_W=posi_W, char_W=char_W, tag_W=tag_W,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_SentPair_tripletloss_Hloss_05_at_exp'
