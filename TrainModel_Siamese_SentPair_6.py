...
from NNstruc.NN_Siamese_SentPair import Model_BiLSTM_SentPair_RelPunish_5
import keras
...
def test_model3_label(nn_model, tag2sentDict_test):
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_BiLSTM_SentPair_RelPunish_5':
        nn_model = Model_BiLSTM_SentPair_RelPunish_5(wordvocabsize=wordvocabsize,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_SentPair_RelPunish_5'
