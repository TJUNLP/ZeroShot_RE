...
from NNstruc.NN_Siamese_SentTriplet import Model_BiLSTM_SentPair_tripletloss_mse_withRank
import keras
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_BiLSTM_SentPair_tripletloss_mse_withRank':
        nn_model = Model_BiLSTM_SentPair_tripletloss_mse_withRank(wordvocabsize=wordvocabsize,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_SentPair_tripletloss_mse_withRank'
