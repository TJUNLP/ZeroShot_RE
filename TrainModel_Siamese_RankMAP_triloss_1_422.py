...
from NNstruc.NN_Siamese import Model_ONBiLSTM_RankMAP_fourloss_Classify_1
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_ONBiLSTM_RankMAP_fourloss_Classify_01_422':
        margin = 0.1
        at_margin = 0.1

        nn_model = Model_ONBiLSTM_RankMAP_fourloss_Classify_1(wordvocabsize=wordvocabsize,
                                                  posivocabsize=posivocabsize,
                                                  charvocabsize=charvocabsize,
                                                    tagvocabsize=tagvocabsize,
                                                  word_W=word_W, posi_W=posi_W, char_W=char_W, tag_W=tag_W,
...
def Dynamic_get_trainSet(istest):
    ...
    inputs_train_x = [train_x1_sent, train_x1_e1_posi, train_x1_e2_posi, train_x1_sent_cahr,
                      train_tag_p, train_tag_n, train_tag_a]
    inputs_train_y = [train_y0, class_label]
...
if __name__ == "__main__":
    ...
    modelname = 'Model_ONBiLSTM_RankMAP_fourloss_Classify_01_422'
