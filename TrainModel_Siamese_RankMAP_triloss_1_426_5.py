...
from NNstruc.NN_Siamese import Model_ONBiLSTM_RankMAP_three_triloss_chain_3
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_ONBiLSTM_RankMAP_three_triloss_chain_3_0080101_426':
        margin1 = 0.08
        margin2 = 0.1
        margin3 = 0.1


        nn_model = Model_ONBiLSTM_RankMAP_three_triloss_chain_3(wordvocabsize=wordvocabsize,
                                                  posivocabsize=posivocabsize,
                                                  charvocabsize=charvocabsize,
                                                    tagvocabsize=tagvocabsize,
                                                  word_W=word_W, posi_W=posi_W, char_W=char_W, tag_W=tag_W,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_ONBiLSTM_RankMAP_three_triloss_chain_3_0080101_426'
