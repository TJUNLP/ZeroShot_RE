...
from NNstruc.NN_Siamese_SentTriplet import Model_BiLSTM_SentPair_tripletloss_mse
import keras
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_BiLSTM_SentPair_tripletloss_mse':
        nn_model = Model_BiLSTM_SentPair_tripletloss_mse(wordvocabsize=wordvocabsize,
                                                  ...
                                                  batch_size=batch_size)
    elif modelname is 'Model_BiLSTM_SentPair_tripletloss_05':
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_SentPair_tripletloss_mse'
