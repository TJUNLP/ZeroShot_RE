...
from NNstruc.NN_Siamese_SentPair import Model_BiLSTM_SentPair_RelPunish_4
import keras
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_BiLSTM_SentPair_RelPunish_4_02':
        nn_model = Model_BiLSTM_SentPair_RelPunish_4(wordvocabsize=wordvocabsize,
                                                  ...
                                                  batch_size=batch_size)
    elif modelname is 'Model_BiLSTM_SentPair_RelPunish_4_0002':
        nn_model = Model_BiLSTM_SentPair_RelPunish_4(wordvocabsize=wordvocabsize,
                                                  posivocabsize=posivocabsize,
                                                  charvocabsize=charvocabsize,
                                                    tagvocabsize=tagvocabsize,
