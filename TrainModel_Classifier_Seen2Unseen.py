...
import os.path
import numpy as np
import ProcessData_Siamese_Seen2Unseen
...
def test_model3(nn_model, tag2sentDict_test):
    ...
    predictions = nn_model.predict(inputs_test_x, batch_size=batch_size, verbose=1)
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_ONLSTM_Classifier_Seen2Unseen':
...
def Dynamic_get_trainSet(shuffle=True):
    ...
    pairs_train, labels_train = ProcessData_Siamese_Seen2Unseen\
        .Create4Classifier(tagDict_train, shuffle, class_num=120)
...
if __name__ == "__main__":
    ...
    modelname = 'Model_ONLSTM_Classifier_Seen2Unseen'
    ...
    datafname = 'WikiReading_data_Siamese.WordChar.Seen2Unseen'
    ...
    if not os.path.exists(datafile):
        ...
        ProcessData_Siamese_Seen2Unseen.get_data(trainfile, testfile,
