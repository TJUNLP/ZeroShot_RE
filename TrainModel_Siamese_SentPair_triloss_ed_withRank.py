...
from NNstruc.NN_Siamese_SentTriplet import Model_BiLSTM_SentPair_tripletloss_ed_withRank
import keras
...
def SelectModel(modelname, wordvocabsize, tagvocabsize, posivocabsize,charvocabsize,
    ...
    if modelname is 'Model_BiLSTM_SentPair_tripletloss_ed_withRank':
        nn_model = Model_BiLSTM_SentPair_tripletloss_ed_withRank(wordvocabsize=wordvocabsize,
...
def Dynamic_get_trainSet(istest):
    ...
    pairs_train, labels_train = ProcessData_Siamese_SentPair.CreateTriplet_withSoftmax(tagDict)
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_SentPair_tripletloss_ed_withRank'
